...
async function testIframeInteraction() {
  ...
  try {
    console.log('📍 Navigating to test checkout...');
    ...
    await page.waitForFunction(() => {
      ...
      return logs && logs.textContent.includes('All iframes present - CollectJS is READY');
    }, { timeout: 30000 });
    ...
    const cardContainer = await page.$('#card-number');
    if (cardContainer) {
